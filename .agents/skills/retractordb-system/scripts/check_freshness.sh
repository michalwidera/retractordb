...
check_external_repo "docs-pl" "$polish_docs_repo" "d49bf5ae232f4a0575b698af2d1d03c6162365a4" || status=1
check_external_repo "docs-en" "$english_docs_repo" "f76fb0aa6935e615776fe85fe85e9ebe1b832b7c" || status=1
exit "$status"
