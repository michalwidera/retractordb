...
- `budowanie-produkcyjne-i-warianty-badawcze.md` — strict production-release checks, isolated probe and ablation
  builds, optimizer-switch identity, and expected ablation-test failures.
