...
- data: 2026-07-22T00:11:12+02:00
- badanie: campaign=rate_fine study_id=4 rate_hz=480 clients=1 samples=20000
...
Mem:           3.7Gi       257Mi       3.2Gi       8.2Mi       318Mi       3.4Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA      5      7      6      4      6      5      5      5      5      6    206 
Node 0, zone    DMA32      2      2      1      2      2      1      1      2      3      4    602 
```
## Load average
```
2.37 0.67 0.23 1/241 1185
```
