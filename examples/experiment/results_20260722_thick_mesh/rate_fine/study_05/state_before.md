...
- data: 2026-07-22T00:13:08+02:00
- badanie: campaign=rate_fine study_id=5 rate_hz=510 clients=1 samples=20000
...
Mem:           3.7Gi       251Mi       3.2Gi       8.2Mi       318Mi       3.5Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA      5      7      6      4      6      5      5      5      5      6    206 
Node 0, zone    DMA32      2      2      1      1     17     14      4      5      1      6    602 
```
## Load average
```
2.23 0.63 0.22 1/244 1183
```
