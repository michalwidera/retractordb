...
- data: 2026-07-22T00:07:15+02:00
- badanie: campaign=rate_fine study_id=2 rate_hz=420 clients=1 samples=20000
...
Mem:           3.7Gi       266Mi       3.2Gi       8.2Mi       318Mi       3.4Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA      5      7      6      4      6      5      5      5      5      6    206 
Node 0, zone    DMA32      1      1      0      2     25     26     17      5      4      6    596 
```
## Load average
```
1.51 0.42 0.14 1/241 1219
```
