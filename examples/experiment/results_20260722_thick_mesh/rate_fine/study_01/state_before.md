...
- data: 2026-07-22T00:05:38+02:00
- badanie: campaign=rate_fine study_id=1 rate_hz=360 clients=1 samples=20000
...
Mem:           3.7Gi       274Mi       3.1Gi       8.3Mi       346Mi       3.4Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA      5      7      6      4      6      5      5      5      5      6    206 
Node 0, zone    DMA32   1161    262     69     35     15     10      6      4      3      3    588 
```
## Load average
```
0.38 0.41 0.26 1/234 2022
```
