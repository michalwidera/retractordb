...
- data: 2026-07-22T00:10:30+02:00
- badanie: campaign=rate_fine study_id=3 rate_hz=450 clients=1 samples=20000
...
Mem:           3.7Gi       274Mi       3.2Gi       9.4Mi       326Mi       3.4Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA      5      7      6      4      6      5      5      5      5      6    206 
Node 0, zone    DMA32    277     60     46     25     17     10      2      3      5      2    595 
```
## Load average
```
2.04 0.84 0.31 1/241 1494
```
## Temperatura (strefy termiczne)
```
/sys/class/thermal/thermal_zone0/temp: 39433 m°C
```
