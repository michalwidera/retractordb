...
- data: 2026-07-21T23:52:20+02:00
- badanie: campaign=rate_dense study_id=1 rate_hz=360 clients=1 samples=20000
...
Mem:           3.7Gi       352Mi       2.8Gi        13Mi       678Mi       3.4Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA    113    110    113    113    108     88     68     55     34     22    174 
Node 0, zone    DMA32   5981   7217   3801   2500   1655   1664    964    506    292    162     84 
```
## Load average
```
3.15 1.59 0.70 1/242 2950
```
## Temperatura (strefy termiczne)
```
/sys/class/thermal/thermal_zone0/temp: 38946 m°C
```
