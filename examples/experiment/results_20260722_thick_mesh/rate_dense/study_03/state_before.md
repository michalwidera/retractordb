...
- data: 2026-07-21T23:55:45+02:00
- badanie: campaign=rate_dense study_id=3 rate_hz=600 clients=1 samples=20000
...
Mem:           3.7Gi       265Mi       3.2Gi       8.1Mi       318Mi       3.4Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA      5      7      6      4      6      5      5      5      5      6    206 
Node 0, zone    DMA32      1      1      1      3      1      3      2      1      3      6    599 
```
## Load average
```
2.78 0.77 0.26 1/244 1181
```
