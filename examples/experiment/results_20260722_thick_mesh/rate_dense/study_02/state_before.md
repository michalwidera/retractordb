...
- data: 2026-07-21T23:53:56+02:00
- badanie: campaign=rate_dense study_id=2 rate_hz=540 clients=1 samples=20000
...
Mem:           3.7Gi       258Mi       3.2Gi       8.1Mi       319Mi       3.4Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA      5      7      6      4      6      5      5      5      5      6    206 
Node 0, zone    DMA32      2      1      2      1      2      2      9      8     11     10    595 
```
## Load average
```
1.99 0.55 0.19 1/241 1209
```
