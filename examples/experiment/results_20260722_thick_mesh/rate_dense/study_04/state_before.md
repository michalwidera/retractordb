...
- data: 2026-07-21T23:57:29+02:00
- badanie: campaign=rate_dense study_id=4 rate_hz=660 clients=1 samples=20000
...
Mem:           3.7Gi       267Mi       3.2Gi       8.2Mi       319Mi       3.4Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA      5      7      6      4      6      5      5      5      5      6    206 
Node 0, zone    DMA32      3      4     16     11      2      2      2      3      0      9    597 
```
## Load average
```
2.54 0.73 0.25 1/241 1185
```
