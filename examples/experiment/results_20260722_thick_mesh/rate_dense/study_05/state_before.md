...
- data: 2026-07-21T23:59:11+02:00
- badanie: campaign=rate_dense study_id=5 rate_hz=700 clients=1 samples=20000
...
Mem:           3.7Gi       262Mi       3.2Gi       8.2Mi       318Mi       3.4Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA      5      7      6      4      6      5      5      5      5      6    206 
Node 0, zone    DMA32      1      0      1      2      1      2     16     13      8      4    597 
```
## Load average
```
1.80 0.52 0.18 1/240 1188
```
