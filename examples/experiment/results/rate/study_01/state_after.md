...
Mem:           3.7Gi       269Mi       2.7Gi        15Mi       822Mi       3.4Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA    359    321    286    249    201     86     81     51     29     20    172 
Node 0, zone    DMA32   5052   8037   4761   2893   1797   1755   1233    549    263    105     70 
```
## Load average
```
1.93 1.70 0.84 1/229 2380
```
