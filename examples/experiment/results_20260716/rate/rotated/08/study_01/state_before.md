...
- data: 2026-07-16T21:58:17+02:00
...
Mem:           3.7Gi       290Mi       2.6Gi       8.2Mi       903Mi       3.4Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA    409    370    335    256    177    130     89     48     17     21    173 
Node 0, zone    DMA32     23   6717   4450   2950   2746   2038   1263    633    291    103      9 
```
## Load average
```
0.46 0.97 0.94 1/241 4090
```
