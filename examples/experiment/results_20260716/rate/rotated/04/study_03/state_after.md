...
- data: 2026-07-16T17:29:27+02:00
- badanie: campaign=rate study_id=3 rate_hz=1080 clients=1 samples=20000
...
Mem:           3.7Gi       252Mi       3.2Gi       9.5Mi       309Mi       3.4Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA      5      7      6      4      6      5      5      5      5      6    206 
Node 0, zone    DMA32    284    138    114     48     42     21     13     16      8     13    595 
```
## Load average
```
1.98 1.07 0.51 1/229 1878
```
## Temperatura (strefy termiczne)
```
/sys/class/thermal/thermal_zone0/temp: 41381 m°C
```
