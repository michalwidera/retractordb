...
- data: 2026-07-16T15:30:10+02:00
...
Mem:           3.7Gi       249Mi       3.2Gi       9.6Mi       303Mi       3.5Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA      5      7      6      4      6      5      5      5      5      6    206 
Node 0, zone    DMA32    471    101     94     44     20     23     22     17      3      7    601 
```
## Load average
```
1.85 1.12 0.52 1/230 2235
```
## Temperatura (strefy termiczne)
```
/sys/class/thermal/thermal_zone0/temp: 41868 m°C
```
