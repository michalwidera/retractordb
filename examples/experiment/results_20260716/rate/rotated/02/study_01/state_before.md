...
- data: 2026-07-16T14:57:45+02:00
...
Mem:           3.7Gi       329Mi       2.2Gi        13Mi       1.3Gi       3.4Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA    186    160    148    146    135    106     70     51     43     39    162 
Node 0, zone    DMA32  12623   7760   7935   6648   4678   2404    933    194     34      5      0 
```
## Load average
```
3.62 3.23 2.45 1/234 3399
```
## Temperatura (strefy termiczne)
```
/sys/class/thermal/thermal_zone0/temp: 43816 m°C
```
