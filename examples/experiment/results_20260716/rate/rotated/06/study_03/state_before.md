...
- data: 2026-07-16T20:40:12+02:00
...
Mem:           3.7Gi       258Mi       3.2Gi       8.2Mi       306Mi       3.4Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA      5      7      6      4      6      5      5      5      5      6    206 
Node 0, zone    DMA32      1      2      1      2     22     27     11     13      8      6    599 
```
## Load average
```
0.51 0.43 0.21 1/237 1226
```
## Temperatura (strefy termiczne)
```
/sys/class/thermal/thermal_zone0/temp: 36024 m°C
```
