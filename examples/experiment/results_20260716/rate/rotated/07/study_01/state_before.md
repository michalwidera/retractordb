...
- data: 2026-07-16T21:50:02+02:00
...
Mem:           3.7Gi       284Mi       2.6Gi        13Mi       905Mi       3.4Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA    409    370    335    256    177    130     89     48     17     21    173 
Node 0, zone    DMA32   8683   7003   3946   2735   2648   1966   1206    590    264     92     31 
```
## Load average
```
2.50 1.76 0.84 1/238 2973
```
