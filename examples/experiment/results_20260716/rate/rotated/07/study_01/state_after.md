...
Mem:           3.7Gi       365Mi       2.5Gi        15Mi       907Mi       3.3Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA    409    370    335    256    177    130     89     48     17     21    173 
Node 0, zone    DMA32   7659   7365   4330   3010   2784   2027   1249    625    287     81      0 
```
## Load average
```
5.25 2.78 1.27 5/231 3259
```
