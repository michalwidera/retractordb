...
- data: 2026-07-16T22:40:01+02:00
...
max / budżet   : 3042.2 %   (PRZEKROCZONY)
przepustowość  : 548 próbek/s (unpaced)
--- E2E: krotka wejściowa -> emisja wyniku (deadline -> boradcast) ---
mediana        : 5017603.3 us
p99            : 9932585.0 us
p99,9          : 10013658.6 us
max            : 10021713.8 us
max / budżet   : 721563.4 %   (PRZEKROCZONY)
--- jitter pobudki (wake_lag) ---
mediana        : 5015839.6 us
p99            : 9930819.3 us
p99,9          : 10011896.3 us
max            : 10019932.6 us
```
...
```
srednie load1=1.68 mem_used_kb=279691 temp_mC=39933
```
