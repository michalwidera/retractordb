...
- data: 2026-07-16T23:20:35+02:00
- badanie: campaign=clients study_id=2 rate_hz=360 clients=2 samples=20000
...
Mem:           3.7Gi       252Mi       3.2Gi       8.2Mi       317Mi       3.4Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA      5      7      6      4      6      5      5      5      5      6    206 
Node 0, zone    DMA32      1      3      2      1      3     21      8      8      5      4    601 
```
## Load average
```
0.42 0.46 0.25 1/239 1218
```
