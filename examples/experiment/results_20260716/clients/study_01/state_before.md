...
- data: 2026-07-16T23:13:52+02:00
- badanie: campaign=clients study_id=1 rate_hz=360 clients=1 samples=20000
...
Mem:           3.7Gi       249Mi       3.2Gi       8.2Mi       350Mi       3.5Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA      5      7      6      4      6      5      5      5      5      6    206 
Node 0, zone    DMA32     23      7     12     28     68     67     21      7      2      6    590 
```
## Load average
```
1.01 0.67 0.29 1/240 1538
```
## Temperatura (strefy termiczne)
```
/sys/class/thermal/thermal_zone0/temp: 37972 m°C
```
