# Stan maszyny -- PRZED badaniem (sledztwo 40ms, badanie pacer-solo)

- data: 2026-07-18T11:58:50+02:00
- parametry: samples=200000 repeats=1 rate=360Hz
...
## Load / pamiec
```
3.28 2.35 1.18 1/231 2051
               total        used        free      shared  buff/cache   available
Mem:           3.7Gi       300Mi       2.5Gi       8.9Mi       1.0Gi       3.4Gi
Swap:             0B          0B          0B
```
## Temperatura
```
