# Stan maszyny -- PRZED badaniem (sledztwo 40ms, badanie engine-shadow)

- data: 2026-07-18T12:23:51+02:00
...
## Load / pamiec
```
0.41 0.18 0.14 1/235 1263
               total        used        free      shared  buff/cache   available
Mem:           3.7Gi       245Mi       3.1Gi       3.2Mi       381Mi       3.5Gi
Swap:             0B          0B          0B
```
## Temperatura
```
