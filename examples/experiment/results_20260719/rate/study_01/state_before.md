...
- data: 2026-07-18T16:39:48+02:00
...
Mem:           3.7Gi       287Mi       2.7Gi        13Mi       819Mi       3.4Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA    714    725    665    574    402    118     77     47     17     12    170 
Node 0, zone    DMA32   2793   8166   4793   2906   1808   1750   1236    547    262    102     70 
```
## Load average
```
2.60 1.74 0.80 1/232 2006
```
