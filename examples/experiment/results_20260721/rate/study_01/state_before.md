...
- data: 2026-07-21T19:59:20+02:00
...
Mem:           3.7Gi       319Mi       2.4Gi        13Mi       1.0Gi       3.4Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA    148    138    130     85     81     68     52     39     35     30    174 
Node 0, zone    DMA32   4947  10304   9960   8211   5600   2629    941    235     84     11      0 
```
## Load average
```
2.29 2.87 2.28 1/237 2574
```
