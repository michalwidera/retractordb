...
Mem:           3.7Gi       311Mi       2.4Gi        15Mi       1.0Gi       3.4Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA    148    138    130     85     81     68     52     39     35     30    174 
Node 0, zone    DMA32   4552  10219   9991   8218   5624   2648    940    236     86     12      0 
```
## Load average
```
1.28 2.49 2.18 1/238 2945
```
