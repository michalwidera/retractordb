...
- data: 2026-07-21T20:17:04+02:00
...
Mem:           3.7Gi       293Mi       3.1Gi       8.3Mi       390Mi       3.4Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA      5      7      6      4      6      5      5      5      5      6    206 
Node 0, zone    DMA32      1      1      2      3      1      1      1      4      2      2    576 
```
## Load average
```
0.64 0.48 0.30 1/240 1955
```
## Temperatura (strefy termiczne)
```
/sys/class/thermal/thermal_zone0/temp: 35050 m°C
```
