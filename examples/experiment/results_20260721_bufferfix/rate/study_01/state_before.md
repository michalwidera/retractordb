...
- data: 2026-07-21T22:59:58+02:00
...
Mem:           3.7Gi       301Mi       1.9Gi        13Mi       1.5Gi       3.4Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA    198    197    180    173    162    145     89     52     45     30    163 
Node 0, zone    DMA32   4318   9960   5740   2810   1267    542    375    360    191     86     22 
```
## Load average
```
2.08 1.54 0.96 1/243 18299
```
