...
- data: 2026-07-17T20:16:31+02:00
- badanie: campaign=baseline-numpy rate_hz=360 samples=20000 batch=650000x5
...
Mem:           3.7Gi       335Mi       3.0Gi       8.6Mi       435Mi       3.4Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA      5      7      6      4      6      5      5      5      5      6    206 
Node 0, zone    DMA32    591    305    369    225     93      6     12      5      0     10    544 
```
## Load average
```
0.43 0.45 0.30 1/234 4025
```
