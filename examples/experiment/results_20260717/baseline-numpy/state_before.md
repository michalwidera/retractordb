...
- data: 2026-07-17T20:15:29+02:00
...
Mem:           3.7Gi       343Mi       3.0Gi       8.1Mi       435Mi       3.4Gi
Swap:             0B          0B          0B
```
## Fragmentacja pamieci (buddyinfo)
```
Node 0, zone      DMA      5      7      6      4      6      5      5      5      5      6    206 
Node 0, zone    DMA32    673    149     59    163     83      6     12      5      0     10    544 
```
## Load average
```
0.69 0.50 0.31 1/233 3610
```
## Temperatura (strefy termiczne)
```
/sys/class/thermal/thermal_zone0/temp: 36511 m°C
```
