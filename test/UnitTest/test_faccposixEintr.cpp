...
class PosixEintrTest : public ::testing::Test {
 protected:
  const std::filesystem::path sandBoxFolder = std::filesystem::temp_directory_path() / "test_faccposixEintr";
...
TEST_F(PosixEintrTest, test_read_eintr_within_limit_succeeds) {
  auto pfa = std::make_unique<rdb::posixBinaryFile>(sandboxPath("test_r_ok"), sizeof(uint8_t));
...
TEST_F(PosixEintrTest, test_read_eintr_exceeds_limit_fails) {
  auto pfa = std::make_unique<rdb::posixBinaryFile>(sandboxPath("test_r_fail"), sizeof(uint8_t));
...
TEST_F(PosixEintrTest, test_write_eintr_within_limit_succeeds) {
  auto pfa = std::make_unique<rdb::posixBinaryFile>(sandboxPath("test_w_ok"), sizeof(uint8_t));
...
TEST_F(PosixEintrTest, test_write_eintr_exceeds_limit_fails) {
  auto pfa = std::make_unique<rdb::posixBinaryFile>(sandboxPath("test_w_fail"), sizeof(uint8_t));
...
TEST_F(PosixEintrTest, test_shadow_read_eintr_within_limit_succeeds) {
  auto pfa = std::make_unique<rdb::posixBinaryFileWithShadow>(sandboxPath("test_shd_r_ok"), sizeof(uint8_t));
...
TEST_F(PosixEintrTest, test_shadow_read_eintr_exceeds_limit_fails) {
  auto pfa = std::make_unique<rdb::posixBinaryFileWithShadow>(sandboxPath("test_shd_r_fail"), sizeof(uint8_t));
...
TEST_F(PosixEintrTest, test_shadow_append_write_eintr_within_limit_succeeds) {
  auto pfa = std::make_unique<rdb::posixBinaryFileWithShadow>(sandboxPath("test_shd_aw_ok"), sizeof(uint8_t));
...
TEST_F(PosixEintrTest, test_shadow_append_write_eintr_exceeds_limit_fails) {
  auto pfa = std::make_unique<rdb::posixBinaryFileWithShadow>(sandboxPath("test_shd_aw_fail"), sizeof(uint8_t));
...
TEST_F(PosixEintrTest, test_shadow_update_write_eintr_within_limit_succeeds) {
  auto pfa = std::make_unique<rdb::posixBinaryFileWithShadow>(sandboxPath("test_shd_uw_ok"), sizeof(uint8_t));
...
TEST_F(PosixEintrTest, test_shadow_update_write_eintr_exceeds_limit_fails) {
  auto pfa = std::make_unique<rdb::posixBinaryFileWithShadow>(sandboxPath("test_shd_uw_fail"), sizeof(uint8_t));
