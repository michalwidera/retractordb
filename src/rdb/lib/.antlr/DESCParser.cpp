...
void descParserInitialize() {
  ...
  auto staticData = std::make_unique<DESCParserStaticData>(
      ...
      std::vector<std::string>{
          "",          "",        "",         "",           "",          "",          "BYTE_T", "STRING_T", "UNSIGNED_T",
          "INTEGER_T", "FLOAT_T", "DOUBLE_T", "RATIONAL_T", "INTPAIR_T", "IDXPAIR_T", "TYPE_T", "REF_T",    "RETENTION_T",
          "DOT",       "MINUS",   "ID",       "STRING",     "DECIMAL",   "FILENAME",  "SPACE"});
  static const int32_t serializedATNSegment[] = {
      ...
      23, 0, 0,  58, 70, 5, 5,  0, 0, 59, 60, 5, 15, 0, 0,  60, 70, 5,  20, 0,  0,  61, 62, 5,  7,  0,  0, 62, 63, 5,
