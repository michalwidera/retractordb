...
namespace rdb
{
    template <class T, class K> DataStorageAccessor<T, K>::DataStorageAccessor(std::string fileName, bool reverse)
    ...
    template <class T, class K> DataStorageAccessor<T, K>::DataStorageAccessor(const Descriptor descriptor, std::string fileName,
        bool reverse)
    ...
    template <class T, class K> DataStorageAccessor<T, K>::~DataStorageAccessor()
    {
        if (removeOnExit) {
