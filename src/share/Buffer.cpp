...
#define MAP_SWICH(__FUNCT__, __PREFUNCT__)            \
    ...
    {                                                 \
    case BF:                                          \
        __PREFUNCT__(*recordInFile).__FUNCT__;        \
        break;                                        \
    case BM:                                          \
        __PREFUNCT__(*recordInMemory).__FUNCT__;      \
        break;                                        \
    default:                                          \
        assert(false);                                \
    case BCF:                                         \
        __PREFUNCT__(*recordInCycleFile).__FUNCT__;   \
        break;                                        \
    case BCM:                                         \
        __PREFUNCT__(*recordInCycleMemory).__FUNCT__; \
        break;                                        \
    };
...
template <class STREAM>
CBlock<STREAM>::CBlock(long frameSize) : pImpl(new STREAM)
{
...
CCycBlock<STREAM>::CCycBlock(long frameSize) : slices(1),
                                               framesInSlice(1),
                                               lastblockCnt(0),
...
template <class IDTYPE>
CBuffer<IDTYPE>::CBuffer() : pImpl(new CBufferImpl<IDTYPE>)
{
}
