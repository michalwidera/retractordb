...
int main(int argc, char *argv[])
{
    try
    {
        ...
        desc.add_options()("help,h", "show help options")("verbose,r", "verbose mode")("dot,d", "create dot file")("csv,c", "create csv file")("view,v", "create dot file and then call dot process")("fields,f", "show fields in dot file")("tags,t", "show tags in dot file")("streamprogs,s", "show stream programs in dot file")("sdump,p", "take as input file executor dump")("leavedot,e", "dont delete temporary dot file")("showtypes,w", "show field types in dot file")("infile,i", po::value<string>(&sInputFile)->default_value("query.qry"), "name of input data file");
