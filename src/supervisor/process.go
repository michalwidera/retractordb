...
func (pm *ProcessManager) StartRetractor(queryFile string) error {
	...
	log.Printf("starting xretractor with %s", queryFile)
...
func (pm *ProcessManager) RunXtrdb(args ...string) (string, error) {
	return pm.runAndLog("xtrdb", pm.cfg.Xtrdb, args)
}

func (pm *ProcessManager) XqryBin() string {
	return pm.cfg.Xqry
}
