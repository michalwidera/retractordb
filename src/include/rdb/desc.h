...
namespace rdb
{
    ...
    struct Descriptor : std::vector<field>
    {
         ...
         *
         * @param l initializer list - this enables create Descriptor as Descriptor obj{field("A",10,String), field("B",10,rdb::String)};
         */
        Descriptor(std::initializer_list<field> l);

        /**
         * @brief Construct a new Descriptor object - only for String (object with len)
         *
         * @param n Field name
         * @param l Field len
         ...
         *
         * As it is a vector ... it wouldn't be necessary - but there are uniqnees name
         * requirement - and if vectors of tuples stacked in container will have same
         * names - these name map will be zeroed and this signs and error
         *
         * @param rhs
         * @return Descriptor&
         */
        ...
        /**
         * @brief Copy constructor a new Descriptor object based on another Descriptor object.
         *
         * @param init
         */
        ...
        /**
         * @brief Get the Size object - it scans all tuples and sums size in bytes of these objects.
         *
        ...
        /**
         * @brief Finds in inner container given tuple by name and return this tuple len
         *
         * @param name Field name
        ...
        /**
         * @brief Counts over inner container and finds offset of given field name from package begining
         *
         * @param name Field name
