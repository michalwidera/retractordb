...
rational<int> deltaTimemove(const rational<int> &arg1, const rational<int> &arg2) { return arg1; }

int agse(int offset, int step) { return floor(boost::rational<int>(offset) / boost::rational<int>(step)); }
