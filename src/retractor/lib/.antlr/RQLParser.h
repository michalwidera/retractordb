...
public:
  enum {
    ...
    IS_NQ = 58, IS_GR = 59, IS_LS = 60, IS_GE = 61, IS_LE = 62, EXCLAMATION = 63, 
    DOUBLE_BAR = 64, DOT = 65, UNDERLINE = 66, AT = 67, SHARP = 68, AND = 69, 
    MOD = 70, DOLLAR = 71, COMMA = 72, SEMI = 73, COLON = 74, DOUBLE_COLON = 75, 
    STAR = 76, DIVIDE = 77, PLUS = 78, MINUS = 79, BIT_NOT = 80, BIT_OR = 81, 
    BIT_XOR = 82, SPACE = 83, COMMENT = 84, LINE_COMMENT1 = 85, LINE_COMMENT2 = 86
  };
