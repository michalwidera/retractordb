...
public:
  enum {
    ...
    FILE = 32, STORAGE = 33, PERCOUNTER = 34, SUBSTRAT = 35, RULE = 36, 
    ON = 37, WHEN = 38, DUMP = 39, SYSTEM = 40, DO = 41, TO = 42, AND_C = 43, 
    OR_C = 44, NOT_C = 45, MIN = 46, MAX = 47, AVG = 48, SUMC = 49, STRING_SUBSTRAT = 50, 
  ...
  public:
    ...
    antlr4::tree::TerminalNode *PERCOUNTER();
