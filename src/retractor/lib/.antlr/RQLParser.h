...
class RQLParser : public antlr4::Parser {
 public:
  ...
  enum {
    ...
    RuleSelect_list         = 9,
    RuleField_id            = 10,
    RuleUnary_op_expression = 11,
    RuleAsterisk            = 12,
    RuleExpression          = 13,
    RuleExpression_factor   = 14,
    RuleTerm                = 15,
    RuleStream_expression   = 16,
    RuleStream_term         = 17,
    RuleStream_factor       = 18,
    RuleAgregator           = 19,
  ...
  class RetentionContext : public antlr4::ParserRuleContext {
   public:
    ...
    void copyFrom(RetentionContext *context);
    using antlr4::ParserRuleContext::copyFrom;

    virtual size_t getRuleIndex() const override;
  };

  class RetetionContext : public RetentionContext {
   public:
    RetetionContext(RetentionContext *ctx);
